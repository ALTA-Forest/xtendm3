 ...
 public class DelBatchCharge extends ExtendM3Transaction {
  ...
  public void main() { 
     ...
     if(!EXTDBC.isPresent()){
        ...
        // Delete record 
        deleteEXTDBCRecord(inCONO, inDIVI, inDBNO, inPUNO, inITNO, inCASN, inCDSE) 
     } 
  ...
  //******************************************************************** 
  void deleteEXTDBCRecord(int CONO, String DIVI, int DBNO, String PUNO, String ITNO, String CASN, String CDSE){ 
