...
public class AddWeightTktLn extends ExtendM3Transaction {
  ...
  public void main() {       
     ...
     String inWTKN
     if (mi.in.get("WTKN") != null && mi.in.get("WTKN") != "") {
        inWTKN = mi.inData.get("WTKN").trim() 
     } else {
        inWTKN = ""         
     }
     ...
     if (mi.in.get("WTDT") != null) {
        ...
        boolean validWTDT = utility.call("DateUtil", "isDateValid", String.valueOf(inWTDT), "yyyyMMdd")  
        if (!validWTDT) {
           mi.error("Weight Date is not valid")   
           return  
        } 
     ...
     String inWTLN
     if (mi.in.get("WTLN") != null && mi.in.get("WTLN") != "") {
        inWTLN= mi.inData.get("WTLN").trim() 
     } else {
        inWTLN = ""         
     }
